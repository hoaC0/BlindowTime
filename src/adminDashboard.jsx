// src/adminDashboard.jsx - verbesserte Version mit sanften Animationen
...
const AdminDashboard = () => {
    ...
    return (
        <div className="admin-container">
            ...
            {/* Container für die Tab-Inhalte mit Animation */}
            <div className="tab-content-container">
                {/* Wir laden alle Komponenten, aber nur eine ist sichtbar */}
                <div className={`tab-content ${selectedTab === 'classes' ? 'active' : ''}`}>
                    <ClassEditor />
                </div>

                <div className={`tab-content ${selectedTab === 'students' ? 'active' : ''}`}>
                ...
                <div className={`tab-content ${selectedTab === 'teachers' ? 'active' : ''}`}>
                    <TeacherManagement />
                </div>

                <div className={`tab-content ${selectedTab === 'notifications' ? 'active' : ''}`}>
                    <AdminNotificationPanel />
                </div>

                <div className={`tab-content ${selectedTab === 'rooms' ? 'active' : ''}`}>
                    <RoomManagement />
                </div>

                <div className={`tab-content ${selectedTab === 'subjects' ? 'active' : ''}`}>
                    <SubjectManagement />
                </div>
            </div>

            {/* Formular-Modal für Schüler */}
            {showStudentForm && (
